...
#define OFFSET_OF_NEG_CONTEXT	0xd0  /* sizeof(struct smb2_negotiate_rsp) - 4 = header(64) + response(64) + GSS_LENGTH(74) + GSS_PADDING(6) */
...
int smb2_negotiate(struct smb_work *smb_work)
{
	...
	inc_rfc1001_len(rsp, sizeof(struct smb2_negotiate_rsp) - sizeof(struct smb2_hdr) - sizeof(rsp->Buffer) + GSS_LENGTH + GSS_PADDING);
