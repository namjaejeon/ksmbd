...
/**
 * smb2_get_info_file_pipe() - handler for smb2 query info on IPC pipe
 * @sess:	session object
 * @req:	query request
 * @rsp:	query response
 * Return:	0 on success, otherwise error
 ...
 * @req:	query info request
 * @rsp:	query info response
 * @rsp_org:	base response buffer pointer in case of chained response
 *
 * Return:	0 on success, otherwise error
 */
 ...
 * @fp:		file pointer of source file
 * @file_info:	FileRenameInformation of set info request
 * @local_nls:	nls object
 *
 * Return:	0 on success, otherwise error
 */
 ...
 *		set info command
 * @work:	smb work containing set info command buffer
 * @share:	ksmbd_share_config object
 * @file_info:	FileLinkInformation of set info request
 * @filp:	file pointer of source file
 * @local_nls:	nls_table object
 *
 * Return:	0 on success, otherwise error
 */
