...
#define ATTR_READONLY_LE	cpu_to_le32(0x00000001)
#define ATTR_HIDDEN_LE		cpu_to_le32(0x00000002)
#define ATTR_SYSTEM_LE		cpu_to_le32(0x00000004)
#define ATTR_DIRECTORY_LE	cpu_to_le32(0x00000010)
#define ATTR_ARCHIVE_LE		cpu_to_le32(0x00000020)
#define ATTR_NORMAL_LE		cpu_to_le32(0x00000080)
#define ATTR_TEMPORARY_LE	cpu_to_le32(0x00000100)
#define ATTR_SPARSE_FILE_LE	cpu_to_le32(0x00000200)
#define ATTR_REPARSE_POINT_LE	cpu_to_le32(0x00000400)
#define ATTR_COMPRESSED_LE	cpu_to_le32(0x00000800)
#define ATTR_OFFLINE_LE		cpu_to_le32(0x00001000)
#define ATTR_NOT_CONTENT_INDEXED_LE	cpu_to_le32(0x00002000)
#define ATTR_ENCRYPTED_LE	cpu_to_le32(0x00004000)
